...
# ==================== KONFIGURATSIYA ====================
class Config:
    BOT_TOKEN = os.getenv("BOT_TOKEN", "7964829221:AAHL6c55tIcIEtrhxVhWVTwCXmqyR0WsUrs")
...
def setup_environment():
    ...
    try:
        ...
        logger.warning("❌ PIL/Pillow kutubxonasi topilmadi")
    ...
    try:
        ...
        logger.warning("❌ ReportLab kutubxonasi topilmadi")
    ...
    try:
        ...
        logger.warning("❌ PyExcel kutubxonasi topilmadi")
    ...
    try:
        ...
        logger.warning("❌ Pandas kutubxonasi topilmadi")
    ...
    try:
        ...
        logger.warning("❌ OpenPyXL kutubxonasi topilmadi")
    ...
    try:
        ...
        logger.warning("❌ RarFile kutubxonasi topilmadi")
            ...
            try:
                ...
                if ext in ['xlsx', 'xls']:
                    if Config.HAS_OPENPYXL:
                        ...
                        info['sheet_names'] = wb.sheetnames[:5]
                elif ext == 'csv':
    ...
    async def _extract_rar(file_path: str, output_dir: str) -> Tuple[bool, str, List[str]]:
        ...
        try:
            if not Config.HAS_RARFILE:
                return False, "RarFile kutubxonasi o'rnatilmagan", []
...
3️⃣ Konvertatsiya qilingan faylni yuklab oling
    ...
    async def extract_archive(self, query, file_id: str):
        ...
        try:
            ...
            if success and extracted_files:
                ...
                # Fayllarni yuborish
                sent_count = 0
                for file_path in extracted_files[:5]:  # Faqat 5 ta fayl
                    try:
                ...
                if len(extracted_files) > 5:
                    await self.app.bot.send_message(
                        ...
                        f"Qolgan {len(extracted_files) - 5} ta fayl hajmi katta yoki cheklovlar tufayli yuklanmadi."
                    )
                else:
                    await self.app.bot.send_message(
                        query.message.chat_id,
...
"""
    ...
    async def cleanup_job(self, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            logger.info(f"Tozalash: {len(expired_files)} ma'lumot o'chirildi")
                
        except Exception as e:
            logger.error(f"Tozalash vazifasi xatosi: {e}")
    ...
    def run(self):
        ...
        try:
            ...
            self.app.add_handler(CommandHandler("extract", self.show_extract_info))
            ...
            # Tozalash vazifasini qo'shish
            job_queue = self.app.job_queue
            if job_queue:
                job_queue.run_repeating(self.cleanup_job, interval=3600, first=10)
