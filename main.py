...
"""
    ...
    async def cleanup_job(self, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
                ...
                if os.path.exists(folder):
                    ...
                    for filename in os.listdir(folder):
                        ...
                        try:
                            ...
                            logger.error(f"Tozalash xatosi {filepath}: {e}")
            ...
            if deleted_files > 0 or deleted_folders > 0 or len(expired_files) > 0:
                logger.info(f"Tozalash: {deleted_files} fayl, {deleted_folders} papka, {len(expired_files)} ma'lumot o'chirildi")
